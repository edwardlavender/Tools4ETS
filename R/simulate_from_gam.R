...
#' @param ind A logical vector, of the same length as the number of rows in \code{newdata}, which defines independent sections of timeseries (see \code{\link[mgcv]{bam}} and the \code{AR.start} argument).
...
#'
#' @return The function returns a posterior distribution matrix for predictions, a summary of these predictions or both.
#'
#' @examples
#' #####################################################
