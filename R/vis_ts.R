#' @title Visualise one dimensional timeseries via R Shiny
#'
#' @importFrom magrittr %>%
#' @import shiny
              ...
              column(
                ...
                box(
                  ...
                  checkboxInput(inputId = "fct_yn",
                                label = strong("Visualise the timeseries for a specific factor level."),
                                value = FALSE),
                  ...
                  conditionalPanel(condition = "input.variable2_yn == true",
                                   ...
                                   radioButtons(inputId = "variable2_method",
                                                ...
                                                choiceNames = c("Colour the timeseries line by the inputted variable.",
                                                                "Add a second y axis and overlay the timeseries of the second variable."),
              ...
              column(
                ...
                box(
                  ...
                  checkboxInput(inputId = "add_summary",
                                label = strong("Add statistical summaries to the timeseries."),
                                value = FALSE),
