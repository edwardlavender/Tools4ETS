...
#' @param fct (optional) A character input which defines the name of a column in \code{dat} which distinguishes different timeseries (i.e., those for different individuals).
...
#'     seed = 1)
#'
#' # Visualise simulated depth timeseries
