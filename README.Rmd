...
A few functions facilitate the computation of simple statistics from time-series data or models. These include: 
...
* **Dataframe assembly.** `assemble_ts()` can be used to simulate time-series dataframes with timestamps for multiple factor levels (if applicable), possibly at different resolutions, over different durations and/or with breaks. 
