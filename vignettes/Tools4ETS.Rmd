...
One of the best ways to evaluate the performance of a model is to overlay observed and expected timeseries. `prettyGraphics::add_error_envelope()` makes this easy, and this is incorporated into `pretty_ts()`:
